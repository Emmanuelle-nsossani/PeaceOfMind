<main id="blog">
    ...
    <div class="active-page" id="articles">
        ...
        <div class="article-container">
            <div>
                <div class="container-img-art">
                    <img src="public\images\article2.png" alt="illustration santé mentale">
                    <p>20/12/24</p>
                </div>
            </div>
            <div class="text-last-article">
                <p>La santé mentale : <br>L'avenir de nos enfants est en jeu</p>
                <p>Les jeunes adultes sont les plus touchés par les problèmes de santé mentale.
        ...
        <div class="article-container">
            <div>
                <div class="container-img-art">
                    <img src="public\images\article3.png" alt="illustration santé mentale">
                    <p>20/12/24</p>
                </div>
            </div>
            <div class="text-last-article">
